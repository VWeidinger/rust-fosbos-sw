...
fn main() {
    ...
    // Runde die Aufgabe, z.B: (radiant * 100.0).round() / 100.0; oder direkt in der Konselen Ausgabe println!("{:.2}", radiant);
    
    // Aufgabe 2
    // Definiere Variable celsius (Testwert 20° Celsius -> Fahrenheit und  Kelvin)
...
// Aufgabe 1
// Definiere die Funktion to_radiant --> Achtung es kann nicht mit zwei unterschiedlichen Typen gerechnet werden(z.B.: i64 und f64 -> geht nicht), wähle deswegen einen Sinnvollen Typ für die Funktion!
// Berechnung Bogenmaß: degree * PI / 180

// Aufgabe 2
// Definiere die Funktion to_other_temperature_units -> um mehrere Werte gleichzeitig zurückzugeben
